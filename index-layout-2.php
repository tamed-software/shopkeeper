					...
					<?php while ( have_posts() ) : the_post(); ?>
							...
							<li class="blog-post">
								...
								<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
									...
									<div class="post-date"><?php the_time('d/m') ?></div>

									<?php the_category(); ?>

									<div class="bg-image-wrapper">
										
										<div class="bg-image" style="background: #F7F7F7 url(<?php echo esc_url( the_post_thumbnail_url( 'large' ) ); ?>)">
									...
									<div class="post_content_wrapper">
										...
										<div class="post_content">
									       ...
									       <?php echo '<p>' . wp_trim_words(get_the_excerpt(), 15) . ' </p>'?>
									        ...
									        <a class="read_more" href="<?php echo get_permalink(); ?>"><?php _e('Continue Reading', 'shopkeeper'); ?></a> 
