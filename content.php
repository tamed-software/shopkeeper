<?php
	...
	if ( (isset($shopkeeper_theme_options['single_post_width'])) ) {
		$content_width_style = $shopkeeper_theme_options['single_post_width']."px";
	}
?>
...
<div class="intro-effect-fadeout">
    ...
    $meta_class = '';
    if( !$shopkeeper_theme_options['post_meta_author'] && !$shopkeeper_theme_options['post_meta_date'] && !$shopkeeper_theme_options['post_meta_categories'] ) {
    	$meta_class = 'no-meta';
    }
		...
		<div class="row">
            <div class="xxlarge-5 xlarge-8 large-12 large-centered columns">
                <div class="title">
                    ...
                    <div class="post_meta <?php echo $meta_class; ?>"> <?php shopkeeper_entry_meta(); ?></div>
                </div>
            </div>
        </div>	
    </div>
			...
			<div class="row">
				...
				<?php endif; ?>
					...
					<div class="entry-content blog-single">
						<?php the_content( __( 'Ver más <span class="meta-nav">&rarr;</span>', 'shopkeeper' ) ); ?>
