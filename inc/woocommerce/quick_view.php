...
if ( GETBOWTIED_WOOCOMMERCE_IS_ACTIVE ) {	
	...
	function getbowtied_product_quick_view_button() {
		...
		if ( (isset($shopkeeper_theme_options['quick_view'])) && ($shopkeeper_theme_options['quick_view'] == 1) ) :
			echo '<a href="#" id="product_id_' . $product->get_id() . '" style="color: #828186 !important;" class="button getbowtied_product_quick_view_button" data-product_id="' . $product->get_id() . '">' . __( 'Vista rápida', 'shopkeeper') . '</a>';
		endif;
	}
