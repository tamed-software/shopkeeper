...
function getbowtied_customizer_styles(){
	...
	$shopkeeper_theme_options['snapchat_link'] 								= getbowtied_theme_option('snapchat_link');
	$shopkeeper_theme_options['medium_link'] 								= getbowtied_theme_option('medium_link');
	$shopkeeper_theme_options['facebook_messenger_link'] 					= getbowtied_theme_option('facebook_messenger_link');
...
if ( !function_exists ('shopkeeper_custom_styles') ) {
	function shopkeeper_custom_styles() {	
		...
		<style>
			...
			{  
			   color: rgba(<?php echo getbowtied_hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.8) !important;
			}
			...
			{
				border-color: rgba(<?php echo getbowtied_hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.8);
			}
			...
			{
				border-color: rgba(<?php echo getbowtied_hex2rgb($shopkeeper_theme_options['headings_color']); ?>,0.35) !important;
				border-right-color: <?php echo esc_html($shopkeeper_theme_options['headings_color']); ?> !important;
			}
			...
			{
				<?php if ( (isset($shopkeeper_theme_options['main_background']['background-color'])) ) : ?>
				background: rgba(<?php echo getbowtied_hex2rgb($shopkeeper_theme_options['main_background']['background-color']); ?>,0.5) !important;;
				<?php endif; ?>
			}
			...
			@media only screen and (min-width: 63.9375em) {
				...
				{
					padding-top: <?php echo esc_html($site_top_bar_height); ?>px;
				}
				...
				<?php 
					$notification_top = $site_top_bar_height + $site_logo_height + $shopkeeper_theme_options['spacing_above_logo'] + $shopkeeper_theme_options['spacing_below_logo'];
				...
				{
					top: <?php echo esc_html($notification_top); ?>px;
				}
