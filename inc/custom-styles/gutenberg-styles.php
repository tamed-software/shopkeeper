		...
		<style>
			...
			<?php 
				...
				if (!empty($shopkeeper_theme_options['headings_font_size'])): 
					...
					.edit-post-visual-editor .wp-block h1 { font-size: <?php echo $h1_size_mobile; ?>px; }
					.edit-post-visual-editor .wp-block h2 { font-size: <?php echo $h2_size_mobile; ?>px; }
					.edit-post-visual-editor .wp-block h3 { font-size: <?php echo $h3_size_mobile; ?>px; } 
					.edit-post-visual-editor .wp-block h4 { font-size: <?php echo $h4_size_mobile; ?>px; }
					.edit-post-visual-editor .wp-block h5 { font-size: <?php echo $h5_size_mobile; ?>px; }
					...
					@media only screen and (min-width: 768px) {
						...
						.edit-post-visual-editor .wp-block h1 { font-size: <?php echo $h1_size; ?>px; }
						.edit-post-visual-editor .wp-block h2 { font-size: <?php echo $h2_size; ?>px; }
						.edit-post-visual-editor .wp-block h3 { font-size: <?php echo $h3_size; ?>px; } 
						.edit-post-visual-editor .wp-block h4 { font-size: <?php echo $h4_size; ?>px; }
						.edit-post-visual-editor .wp-block h5 { font-size: <?php echo $h5_size; ?>px; }
...
if ( !function_exists ('shopkeeper_custom_gbt_editor_styles') ) {
	function shopkeeper_custom_gbt_editor_styles() {
		...
		if ( method_exists($current_screen, 'is_block_editor') && $current_screen->is_block_editor() ) {
		    $styles = shopkeeper_custom_gutenberg_editor_styles();
			echo $styles;
		}
	}
}
