					...
					<style type="text/css">
						...
						<div class="row">
							<div class="tob_bar_shop">
								<div class="row">
									<div class="small-5 medium-6 columns text-left">
										  ...
										  <div class="category_grid_box">
											  ...
											  <a href="<?php echo get_term_link( $category->slug, 'product_cat' ); ?>" class="category_item">
												<span class="category_name"><?php echo esc_html($category->name); ?>
													...
													<?php if( isset($shopkeeper_theme_options['categories_grid_count']) && $shopkeeper_theme_options['categories_grid_count'] ) : ?>
