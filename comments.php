    ...
    <div class="xlarge-6 large-8 xlarge-centered large-centered columns without-sidebar">
        ...
        <div id="comments" class="comments-area">
            ...
            $getbowtied_comment_args = array(		
                ...
                'title_reply' => __( 'Deja tu comentario', 'shopkeeper' ),
            
                'fields' => apply_filters( 'comment_form_default_fields', array(
                
                    'author' 	=> 	'<div class="row"><div class="large-6 columns"><p class="comment-form-author">' . '<label for="author">' . __( 'Nombre', 'shopkeeper' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
                                    '<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></p></div>',
                    'email'  	=> 	'<div class="large-6 columns"><p class="comment-form-email"><label for="email">' . __( 'Correo', 'shopkeeper' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
                                    '<input id="email" name="email" type="email" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></p></div></div>',
                    'url'   	=> 	'<div class="row"><div class="large-12 columns"><p class="comment-form-url"><label for="url">' . __( 'Sitio web', 'shopkeeper' ) . '</label> ' .
                ...
                'comment_field' =>	'<div class="row"><div class="large-12 columns"><p>' .	
                                    '<label for="comment">' . __( 'Escribe tu comentario', 'shopkeeper' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label>' .
