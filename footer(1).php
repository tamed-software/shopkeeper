								                ...
								                <div class="main-footer-inner">
												    ...
												    <div class="footer-items-2">
												        <ul class="footer-list-2">
												            <li class="footer-item"><a class="id-no-nav" onclick="Redireccionar('<?php echo home_url(); ?>/contacto-2/')" target="_blank">Contacto</a></li>
										    ...
										    <div class="footer-bottom">
										        <div class="footer-bottom-main">
										            ...
										            <ul class="bottom-items">
										                ...
										                <li class="footer-item"><a onclick="Redireccionar('<?php echo home_url(); ?>/store/')">Catálogo</a></li>
			                               	...
			                               	<section2>
												<div class="icon-container" onclick="Redireccionar('<?php echo home_url(); ?>')">
												  ...
												  <div class="text">Soporte</div>
												   ...
												   <div class="icon-container" onclick="Redireccionar('<?php echo home_url(); ?>/contacto-2')">
												  <div class="icon">
	...
	switch ($url2) {
		      ...
		      <div class="modal-body">
		        <div class="form_popup_subscribe" style="border:0;">
		          ...
		          <!-- inicio stilos de eloqua -->
		    		<style type="text/css" href="<?php echo home_url(); ?>/wp-content/themes/shopkeeper/modales/css/blog.css"></style>
		    	   <!-- fin stilos de eloqua -->
		    	   <!-- inicio formulario de eloqua -->
					<form class="elq-form" name="copiaDeHome2019-1567700423723" id="form65" action="https://s242003202.t.eloqua.com/e/f2" method="post" onsubmit="return handleFormSubmit(this)">
					  <input value="copiaDeHome2019-1567700423723" type="hidden" name="elqFormName">
					        ...
					        <div class="layout-col col-sm-6 col-xs-12">
					          <div id="formElement0" class="elq-field-style form-element-layout row">
					            <div style="text-align:left;" class="col-sm-12 col-xs-12">
					              <label class="elq-label " for="fe435">Nombre
					              ...
					              <div class="row">
					                <div class="col-xs-12">
					                  <div class="field-control-wrapper">
					                    <input type="text" class="elq-item-input" name="firstName" id="fe435" value="" style="width:100%;">
					                  </div>
					                </div>
					              </div>
					            </div>
					      ...
					      <div class="grid-layout-col">
					        <div class="layout-col col-sm-6 col-xs-12">
					          <div id="formElement1" class="elq-field-style form-element-layout row">
					            <div style="text-align:left;" class="col-sm-12 col-xs-12">
					              <label class="elq-label " for="fe436">Apellido
					                <span class="elq-required">*
					                </span>
					              </label>
					            </div>
					            <div class="col-sm-12 col-xs-12">
					              <div class="row">
					                <div class="col-xs-12">
					                  <div class="field-control-wrapper">
					                    <input type="text" class="elq-item-input" name="lastName" id="fe436" value="" style="width:100%;">
					                  </div>
					                </div>
					              </div>
					            </div>
					      ...
					      <div class="grid-layout-col">
					        <div class="layout-col col-sm-12 col-xs-12">
					          <div id="formElement2" class="elq-field-style form-element-layout row">
					            <div style="text-align:left;" class="col-sm-12 col-xs-12">
					              <label class="elq-label " for="fe429">Email
					                <span class="elq-required">*
					                </span>
					              </label>
					            </div>
					            <div class="col-sm-12 col-xs-12">
					              <div class="row">
					                <div class="col-xs-12">
					                  <div class="field-control-wrapper">
					                    <input type="text" class="elq-item-input" name="emailAddress" id="fe429" value="" style="width:100%;">
					                  </div>
					                </div>
					              </div>
					            </div>
					          ...
					          <div id="formElement3" class="elq-field-style form-element-layout row">
					            <div class="col-sm-12 col-xs-12">
					              <div class="row">
					                <div class="">
					                  <div>
					                    <input type="Submit" onclick="click_form()" class="submit-button-style " value="Suscribirme" id="fe430">
					                  </div>
					                  <a href="#close-modal" rel="modal:close" onclick="click_nomostrar()" style="font-size: 9px">No, gracias</a>
					                </div>
					              </div>
					            </div>
					          </div>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <div class="form_popup_subscribe" style="border:0;">
		          ...
		          <!-- inicio stilos de eloqua -->
		    		<style type="text/css" href="<?php echo home_url(); ?>/wp-content/themes/shopkeeper/modales/css/inmobiliaria.css"></style>
		    	   <!-- fin stilos de eloqua -->
		    	   <!-- inicio formulario de eloqua -->
		    	   <form class="elq-form" name="copiaDeBlog2019-1569261019549" id="form68" action="https://s242003202.t.eloqua.com/e/f2" method="post" onsubmit="return handleFormSubmit(this)">
					  <input value="copiaDeBlog2019-1569261019549" type="hidden" name="elqFormName">
					  <input value="242003202" type="hidden" name="elqSiteId">
					  <input name="elqCampaignId" type="hidden">
					  <div class="layout container-fluid">
					    <div class="row">
					      <div class="grid-layout-col">
					        <div class="layout-col col-sm-6 col-xs-12">
					          <div id="formElement0" class="elq-field-style form-element-layout row">
					            <div style="text-align:left;" class="col-sm-12 col-xs-12">
					              <label class="elq-label " for="fe452">Nombre
					                <span class="elq-required">*
					                </span>
					              </label>
					            </div>
					            <div class="col-sm-12 col-xs-12">
					              <div class="row">
					                <div class="col-xs-12">
					                  <div class="field-control-wrapper">
					                    <input type="text" class="elq-item-input" name="firstName" id="fe452" value="" style="width:100%;">
					                  </div>
					                </div>
					              </div>
					            </div>
					      ...
					      <div class="grid-layout-col">
					        <div class="layout-col col-sm-6 col-xs-12">
					          <div id="formElement1" class="elq-field-style form-element-layout row">
					            <div style="text-align:left;" class="col-sm-12 col-xs-12">
					              <label class="elq-label " for="fe453">Apellido
					                <span class="elq-required">*
					                </span>
					              </label>
					            </div>
					            <div class="col-sm-12 col-xs-12">
					              <div class="row">
					                <div class="col-xs-12">
					                  <div class="field-control-wrapper">
					                    <input type="text" class="elq-item-input" name="lastName" id="fe453" value="" style="width:100%;">
					                  </div>
					                </div>
					              </div>
					            </div>
					    ...
					    <div class="row">
					      <div class="grid-layout-col">
					        <div class="layout-col col-sm-12 col-xs-12">
					          <div id="formElement2" class="elq-field-style form-element-layout row">
					            <div style="text-align:left;" class="col-sm-12 col-xs-12">
					              <label class="elq-label " for="fe454">Dirección de correo electrónico
					                <span class="elq-required">*
					                </span>
					              </label>
					            </div>
					            <div class="col-sm-12 col-xs-12">
					              <div class="row">
					                <div class="col-xs-12">
					                  <div class="field-control-wrapper">
					                    <input type="text" class="elq-item-input" name="emailAddress" id="fe454" value="" style="width:100%;">
					                  </div>
					                </div>
					              </div>
					            </div>
					                    ...
					                    <div id="formElement3" class="elq-field-style form-element-layout row">
					                        <div class="col-sm-12 col-xs-12">
					                            <div class="row" style="margin-top: 20px">
													<div class="">
														<div>
															<input type="Submit" onclick="click_form()" class="submit-button-style " value="Suscribirme" id="fe450">
														</div>
		...
		<div class="modal fade" id="pop-up-newsletter2" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		        ...
		        <div class="form_popup_subscribe" style="border:0;">
		          <!-- inicio stilos de eloqua -->
		    		<style type="text/css" href="<?php echo home_url(); ?>/wp-content/themes/shopkeeper/modales/css/home.css"></style>
		    	   <!-- fin stilos de eloqua -->
		    	   <!-- inicio formulario de eloqua -->
					 <form class="elq-form" name="copiaDeHome2019-1567702174742" id="form66" action="https://s242003202.t.eloqua.com/e/f2" method="post" onsubmit="return handleFormSubmit(this)">
						  <input value="copiaDeHome2019-1567702174742" type="hidden" name="elqFormName">
						  <input value="242003202" type="hidden" name="elqSiteId">
						  <input name="elqCampaignId" type="hidden">
						  <div class="layout container-fluid">
						    <div class="row">
						      <div class="grid-layout-col">
						        <div class="layout-col col-sm-6 col-xs-12">
						          <div id="formElement0" class="elq-field-style form-element-layout row">
						            <div style="text-align:left;" class="col-sm-12 col-xs-12">
						              <label class="elq-label " for="fe439">Nombre
						                <span class="elq-required">*
						                </span>
						              </label>
						            </div>
						            <div class="col-sm-12 col-xs-12">
						              <div class="row">
						                <div class="col-xs-12">
						                  <div class="field-control-wrapper">
						                    <input type="text" class="elq-item-input" name="firstName" id="fe439" value="" style="width:100%;">
						                  </div>
						                </div>
						              </div>
						            </div>
						      ...
						      <div class="grid-layout-col">
						        <div class="layout-col col-sm-6 col-xs-12">
						          <div id="formElement1" class="elq-field-style form-element-layout row">
						            <div style="text-align:left;" class="col-sm-12 col-xs-12">
						              <label class="elq-label " for="fe440">Apellido
						                <span class="elq-required">*
						                </span>
						              </label>
						            </div>
						            <div class="col-sm-12 col-xs-12">
						              <div class="row">
						                <div class="col-xs-12">
						                  <div class="field-control-wrapper">
						                    <input type="text" class="elq-item-input" name="lastName" id="fe440" value="" style="width:100%;">
						                  </div>
						                </div>
						              </div>
						            </div>
						    ...
						    <div class="row">
						      <div class="grid-layout-col">
						        <div class="layout-col col-sm-12 col-xs-12">
						          <div id="formElement2" class="elq-field-style form-element-layout row">
						            <div style="text-align:left;" class="col-sm-12 col-xs-12">
						              <label class="elq-label " for="fe433">Email
						                <span class="elq-required">*
						                </span>
						              </label>
						            </div>
						            <div class="col-sm-12 col-xs-12">
						              <div class="row">
						                <div class="col-xs-12">
						                  <div class="field-control-wrapper">
						                    <input type="text" class="elq-item-input" name="emailAddress" id="fe433" value="" style="width:100%;">
						                  </div>
						                </div>
						              </div>
						            </div>
		...
		<iframe style="margin-bottom: -7px;" width="100%" height="480" src="https://www.youtube.com/embed/J2I_PolB3HY?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
		<?php  break;
		case  "/cl/store/": ?>
		<script src="<?php echo home_url(); ?>/wp-content/themes/shopkeeper/modales/js/jquery.min.js"></script>
