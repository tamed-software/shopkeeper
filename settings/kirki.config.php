...
if ( class_exists( 'Kirki' ) ) {
	 ...
	 */
		/* Product Page */
			...
			Kirki::add_field( 'shopkeeper', array(
				'type'        => 'toggle',
				'settings'    => 'También podría interesarte',
	 ...
	 */
		/* Social Media */
			...
			Kirki::add_field( 'shopkeeper', array(
				...
				'label'       => esc_attr__( 'Snapchat', 'shopkeeper' ),
				'section'     => 'social_media',
				'default'     => '',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'shopkeeper', array(
				...
				'label'       => esc_attr__( 'Medium', 'shopkeeper' ),
				'section'     => 'social_media',
				'default'     => '',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'shopkeeper', array(
				'type'        => 'text',
				'settings'    => 'facebook_messenger_link',
				'label'       => esc_attr__( 'Facebook Messenger', 'shopkeeper' ),
				'section'     => 'social_media',
				'default'     => '',
				'priority'    => 10,
			));
